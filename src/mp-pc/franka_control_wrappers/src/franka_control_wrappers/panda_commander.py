...
class PandaCommander(object):
    ...
    def set_named_poses(self):
        ...
        grip_ready_joint_values = [-0.1706, -0.8882, -0.8514, -1.9803, -0.6403, 1.3514, 0.6152]
        self.active_group.remember_joint_values('grip_ready', grip_ready_joint_values)
        print(grip_ready_joint_values)
        #                                                                                                1        2        3        4        5        6        7
        ...
        drop_box_joint_values = [ 0.8263,  1.0896,  0.8203, -0.8825, -0.7649,  1.7213,  2.2823]
        self.active_group.remember_joint_values('drop_box', drop_box_joint_values)
        print(drop_box_joint_values)
