...
class HRNet(nn.Module):
    def __init__(self, input_channels=3,cfg=None):
        ...
        out_channels=1
        self.pos_output = nn.Conv2d(19, out_channels, kernel_size=1)
        self.cos_output = nn.Conv2d(19, out_channels, kernel_size=1)
        self.sin_output = nn.Conv2d(19, out_channels, kernel_size=1)
        self.width_output = nn.Conv2d(19, out_channels, kernel_size=1)
...
if __name__ == '__main__':
    ...
    # print(config.MODEL.STAGE_2)
    print(img.shape)


    from parm import config
    model=HRNet(input_channels=3,cfg=config)
    print(type(model))
    a,b,c,d=model(img)
    print(a.shape)
    print(model)
